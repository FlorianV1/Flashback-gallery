    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm" style="color: #8B7355;">
                No account yet?
                <a href="{{ route('register') }}" style="color: #E85D04;" onmouseenter="this.style.textDecoration='underline'" onmouseleave="this.style.textDecoration='none'">Sign up</a>
            </p>
        </div>

        @if($failed)
            <div class="mb-4 px-4 py-3 rounded-sm text-sm" style="background: #FEF0E7; color: #C84B00; border: 1px solid #F9C6A0;">
        ...
        <form wire:submit="login" class="space-y-5">
            ...
            <div class="flex items-center gap-2">
                <input wire:model="remember" type="checkbox" id="remember" class="rounded-sm" style="accent-color: #E85D04;">
                <label for="remember" class="text-sm" style="color: #8B7355;">Remember me</label>
            </div>
